...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Veterans Treatment Court Coordination System";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "justice-involved veteran";
process.env.TABLE_NAME = process.env.TABLE_NAME || "justice_involved_veteran_records";
'use strict';
